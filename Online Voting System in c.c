...
void voter_insert()
{
    ...
    while(temp!=NULL)
    {
        if( (strcmp(temp->id,"2234")==0 && strcmp(temp->name,"Roman Molla")==0)||
            (strcmp(temp->id,"2233")==0 && strcmp(temp->name,"Shafiqul Islam")==0)||
            (strcmp(temp->id,"2232")==0 && strcmp(temp->name,"Jahirul Islam")==0)
          )
